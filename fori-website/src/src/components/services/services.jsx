...
function Services(){
    ...
    return(
        ...
        {data1.map((item,index)=>{
                 return(
                   ...
                   <Paper className={classes.root}><div  key={index}>
                    ...
                    <><p className="b5_Card_para">{show?item.p:item.p.substring(0, 100)} <button className="b5_Card_showBtn" onClick={showMore}>{show?"Show less":"...Show More"}</button></p>
                   </>}
                    </div>
                </Paper>
                </div>
        ...
        {data.map((item,index)=>{
                 return(
                    <div  style={{ width: "35rem" ,height:"30rem" }}>
                   ...
                   <div className="services_caresoul_Card_img">
                    ...
                    {item.p.length<=200?<p style={{color:"white"}} className="b5_Card_para">{item.p}</p>:
                    <><p className="b5_Card_para" style={{color:"white"}} >{show?item.p:item.p.substring(0, 200)} <button style={{color:"white"}}  className="b5_Card_showBtn" onClick={showMore}>{show?"Show less":"...Show More"}</button></p>
                   </>}
                   </div>
                    </div>
                </div>)
