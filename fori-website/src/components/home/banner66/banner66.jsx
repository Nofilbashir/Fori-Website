...
function Banner66 (){
    ...
    return(
        <>
        <div className="b66">
        <div className='b66__paper'>
        <Paper className={classes.root}>
                <h1 className='b66_card_heading'>Acheivments</h1>
                <ul className='b66_Card_list'>
                    {data1.map((i,index)=>{
                    
               return  <div className='b66_card_points' key={index}><BsCheck2Circle/> <li className='b66_Card_L'>{i}</li></div>
            })}
                </ul>
                <div style={{width:"100%"}}>
                <img style={{width:"100%"}} src={require("./Group48.png")} alt="group"/>
                </div>
            </Paper>
            </div>
